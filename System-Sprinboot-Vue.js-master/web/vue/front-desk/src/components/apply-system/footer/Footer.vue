  ...
  <footer class="footer">
    <el-col :span="8">
      <div class="footer-content footer-left">
        <div class="copyright footer-title">Copyright © 2022 王金祥</div>
      </div>
    </el-col>
    <el-col :span="8">
      <div class="footer-content footer-left">
        <div class="bold footer-title">Contract</div>
        <div class="middle">Inner Mongolia Agricultural University of Science and Technology</div>
        <div class="middle">owjxo@qq.com</div>
      </div>
    </el-col>
    <el-col :span="8">
